...
_TARGETS: dict[tuple[ToolName, SkillName], SkillTarget] = {
    ...
    ("pi", "autosentry"): SkillTarget(
        tool="pi",
        skill="autosentry",
        template="pi.md",
        local_destination=Path(".pi/prompts/autosentry.md"),
        global_destination=_home() / ".pi/agent/prompts/autosentry.md",
        label="Pi (pi.dev) prompt template — `/autosentry`",
    ),
    ...
    ("pi", "init"): SkillTarget(
        ...
        skill="init",
        template="pi_init.md",
        local_destination=Path(".pi/prompts/autosentry-init.md"),
        global_destination=_home() / ".pi/agent/prompts/autosentry-init.md",
        label="Pi `/autosentry-init` prompt template",
    ),
    ...
    ("pi", "update"): SkillTarget(
        tool="pi",
        skill="update",
        template="pi_update.md",
        local_destination=Path(".pi/prompts/autosentry-update.md"),
        global_destination=_home() / ".pi/agent/prompts/autosentry-update.md",
        label="Pi `/autosentry-update` prompt template",
    ),
